                            ...
                            <div class="bg-white overflow-hidden cursor-pointer hover:shadow-lg transition-all duration-300 relative">
                                <a href="javascript:void(0)" class="block">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <h4 className="text-[15px] text-slate-900 font-medium leading-relaxed">{items.title}</h4>
                                        ...
                                        <div className="flex items-center mt-2">
                                            <div className="flex items-center space-x-1">
                                                {[1, 2, 3, 4, 5].map((star) => (
                                                    <svg
                                                        key={star}
                                                        className={`w-4 h-4 ${star <= items.rating ? "fill-[#facc15]" : "fill-[#CED5D8]"}`}
                                                        viewBox="0 0 14 13"
                                            ...
                                            <span className="text-[15px] text-slate-900 font-medium ml-2">{items.rating}/5</span>
                                        </div>
                                        <h4 class="text-base text-slate-900 font-semibold mt-4">${items.price} <span className='text-sm text-gray-400 line-through'>{items.oldPrice}</span>
                                            <span className='bg-red-200 text-[14px] ml-3 text-red-700 font-light rounded-[40px]'>{items.discount}</span></h4>
