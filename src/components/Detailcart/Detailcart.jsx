          ...
          <div class="w-full">
            <div>
              ...
              <div class="flex items-center flex-wrap gap-4 mt-6">
                <h4 class="text-slate-900 text-2xl sm:text-3xl font-semibold">$ {mehsul.price}</h4>
                <s class="text-slate-500 text-lg font-bold">{mehsul.oldPrice} %</s>
              </div>

              <div class="flex items-center gap-4 mt-4">
               
                <p class="text-slate-500 text-sm">{mehsul.description}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-4 mt-4">
                    ...
                    <div>
                  <button type="button"
                    class="px-4 py-2 border border-slate-300 bg-slate-100 hover:bg-slate-200 text-slate-900 text-sm font-medium"></button>
               </div>
