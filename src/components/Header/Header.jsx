        ...
        <header className="flex bg-white border-b border-gray-300 py-3 sm:px-6 px-4 min-h-[75px] tracking-wide relative z-50">
            <div className="flex max-w-screen-xl mx-auto w-full">
                <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
                    <b className='text-3xl font-integral font-extrabold uppercase'>Shop.CO</b>
                        ...
                        <ul
                            ...
                            <li className="mb-6 hidden max-lg:block">
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <button
                                        className="px-4 py-2 text-sm rounded-full text-white border-2 border-blue-700 bg-blue-700 hover:bg-[#004bff]">
                                        On Sign</button>
                                </div>
                            </li>
                            <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
                                <Link
                                    to="/category"
                                    className="text-blue-700 hover:text-blue-800 text-[15px] block font-semibold"
                                >
                                    Shop
                                </Link>
                            </li>
                    ...
                    <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
                        <div
                            className="flex bg-gray-50 border w-[500px] border-gray-300 focus-within:bg-transparent focus-within:border-gray-500 rounded-full px-4 py-2.5 overflow-hidden  max-xl:hidden">
                            ...
                            <input type='text' placeholder='Search something...' className="w-full ml-9 text-sm bg-transparent outline-0 pr-2" />
