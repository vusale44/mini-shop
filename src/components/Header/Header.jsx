...
const Header = () => {
const {len} = useContext(ProductContext)
                    ...
                    <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
                       <Search/>
                        ...
                        <div className="flex items-center sm:space-x-8 space-x-6">
                            ...
                            <div className="flex flex-col items-center justify-center gap-0.5 cursor-pointer">
                                <div className="relative">
                                   <Link to="/Cart"> <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="cursor-pointer fill-[#333] inline"
                                        viewBox="0 0 512 512">
                                        <path
                                    ...
                                    <span className="absolute left-auto -ml-1 top-0 rounded-full bg-red-500 px-1 py-0 text-xs text-white">{len}</span>
                                </div>
