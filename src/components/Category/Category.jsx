...
const Category = () => {
    ...
    let categorysize = ["All", ...new Set(sizeAll.map((item) => item))]
    let filtersize = size === "All" ? filtercolor : filtercolor.filter((item) => item.sizes.includes(size))
