...
const Category = () => {
    ...
    const sizeAll = ["XX-Small", "X-Small", "Small", "Medium", "Large", "X-Large", "XX-Large", "3X-Large", "4X-Large"];
    ...
    const currentProducts = filterprice.slice(firstItemIndex, lastItemIndex);

    // Filtr dəyişəndə səhifəni 1-ə qaytaran funksiya
    const handleFilterChange = (type, value) => {
        if (type === 'cat') setCat(value);
    ...
    return (
        ...
        <div >
                                        ...
                                        <div onClick={() => navigate(`/product/${product.id}`)}
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="flex items-center flex-wrap gap-2 mt-2">
                                                    ...
                                                    {product.discount > 0 && (
                                                        <>
                                                            <s className="text-[#0000004D] text-[16px] font-semibold">${product.price}</s>
                                                            <span className="w-[50px] h-[28px] font-semibold text-[14px] text-[#FF3333] flex justify-center items-center bg-[#FF33331A] ml-2 border rounded-[62px]">-{product.discount}%</span>
                                                        </>
                                                    )}
                                                </div>
                                            </div>
           ...
           <div className='flex justify-center items-center w-[100%] py-10'>
                <Pagination 
                    totalItems={filterprice.length} 
